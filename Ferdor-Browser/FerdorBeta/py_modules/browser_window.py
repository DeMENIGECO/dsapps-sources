...
class BrowserWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Ferdor Beta")
    ...
    def _add_pages_menu(self):
        ...
        menu.addAction("FAQs", lambda: self.load("https://demenigeco.github.io/dsapps/docs/?VAI_ALLA_SEZIONE=Ferdor%20Beta"))
        menu.addAction("DomePrograms for Developer", lambda: self.load("https://demenigeco.github.io/dsapps/developers/"))
        menu.addAction("GitHub Releases", lambda: self.load("https://github.com/DeMENIGECO/dsapps/releases/tag/App_dsapps_FerdorBeta"))
