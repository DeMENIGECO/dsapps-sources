...
USER_DIR = os.path.expanduser("~/.FerdorBeta")
    ...
    # ---------------- fe://config ----------------
        ...
        if not os.path.exists(CONFIG_FILE):
            with open(CONFIG_FILE, "w") as f:
                f.write("\nprivacy_mode=0\nautocomplete=1\nother=532;893;883;988;937;973;86")
        ...
        <body>
            ...
            <div class="card">
                ...
                <p>Other Configuratiuons for Beta:</p>
                <label>Windows.BrowserAppPatch._beta</label>
                <input type="checkbox" checked>
                <label>Windows.beta-_xservice</label>
                <input type="checkbox">
                <label>Mozzila.FocusedWindow</label>
                <input type="checkbox" checked>
                <label>Mozzilla.PyLanceService._dlls</label>
                <input type="checkbox">
                <label>dsapps.BetaCountib</label>
                <input type="checkbox">
                <label>dsapps.countrib._dispach.corrcted_fat</label>
                <input type="checkbox" checked>
                <label>w.envrollementdlls</label>
                <input type="checkbox">
                <label>akams.bitlocker</label>
                <input type="checkbox">
                <label>dsapps.betabrowserservices</label>
                <input type="checkbox">
                <label>dsapps.ncritt</label>
                <input type="checkbox">
                <label>dsapps.migliorament</label>
                <input type="checkbox" checked>
            </div>
        </body>
        </html>
